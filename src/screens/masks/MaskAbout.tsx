  ...
  return (
    <div className='relative w-full h-[100dvh] flex justify-center items-center'>
        <div className='flex flex-col gap-10 justify-center items-start px-10 lg:px-50'>
            ...
            <div ref={container} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className='text-[2.7em] lg:text-[65px] tracking-[-2.67px] leading-[54.7px] font-bold'>
