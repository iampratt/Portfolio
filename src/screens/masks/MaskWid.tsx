...
function Wid() {
  ...
  return (
    <div className="relative w-full h-[100dvh] flex flex-col justify-center overflow-hidden">
      <div className="font-bold text-[#b7ab98] text-[10px] lg:text-[11.1px] tracking-[4px] lg:tracking-[5.83px] leading-[21px] mb-3 xl:mb-6 px-5 xl:px-50">
        WHAT I DO
      </div>
        ...
        >
          <div className="relative top-0" >
            ...
            <div className="relative h-[80px] lg:h-[4.1em] xl:h-[7em] flex items-center px-5 xl:px-50 overflow-clip">
              <div
                className="font-semibold text-[2.5rem] lg:text-[4.7em] xl:text-[9em] tracking-[-2px] lg:tracking-[-5.83px] leading-tight lg:leading-[98px] text-[#b7ab98] scrollText whitespace-nowrap">
                {skill.title}
              </div>
            </div>
          </div>
          ...
          <div
            ...
            <div className="relative h-[80px] lg:h-[4.1em] xl:h-[7em] bg-[#eb5939]">
              <div className="flex justify-between items-center h-full px-5 xl:px-50 overflow-clip">
                <div className="font-semibold text-[2.5rem] lg:text-[4.7em] xl:text-[9em] tracking-[-2px] lg:tracking-[-5.83px] leading-tight lg:leading-[98px] text-[#0d0d0d] mr-20 whitespace-nowrap">
                  {skill.title}
                </div>
              </div>
            </div>
